"""Ученики решили выяснить, кто из них быстрее всех решит домашнее задание по математике. Для этого каждый ученик
...
приведенный ниже код, чтобы он вывел имя ученика, который затратил на решение домашнего задания меньше всего времени.
...
print(min(data, key=lambda k: datetime.strptime(data[k][1], '%d.%m.%Y %H:%M:%S') - datetime.strptime(data[k][0],
                                                                                                     '%d.%m.%Y %H:%M:%S')))
